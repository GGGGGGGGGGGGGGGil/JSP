...
public class ArticleDAO { //DAO에서 DBCP 상속받는게 더 편함
	...
	//기본 CRUD(insert, select, update, delete 말함)
	...
	public List<ArticleBean> selectArticles(int start) { //select라 반환값 필요
	...
	public String deleteFile(String parent) {
		...
		try {
			...
			psmt1.setString(1, parent); //쿼리 파라미터 각각 한개씩 있어서 둘다 1임
