            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnUidCheck"><img src="/JBoard1/img/chk_id.gif" alt="중복확인1"></button>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnNickCheck"><img src="/JBoard1/img/chk_id.gif" alt="중복확인2"></button>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <button type="button" onclick="postcode()"><img src="/JBoard1/img/chk_post.gif" alt="우편번호"></button>
                        </div>
                        <div>
