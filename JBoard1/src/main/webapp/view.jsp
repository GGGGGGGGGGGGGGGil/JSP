...
<%@page import="kr.co.jboard1.bean.ViewBean"%>
...
<script> //클라이언트에서 실행됨
	...
	$(document).ready(function(){
		...
		$('.commentForm > form').submit(function(){
			...
			$.ajax({
				url : '/JBoard/proc/commentWriteProc.jsp',
				method : 'POST',
				data: jsonData,
				dataType : 'json',
        ...
        <main id="board" class="view">
            <table>
                ...
                <tr>
                    <th>파일</th>
                    <td>
                    	<a href="/JBoard1/proc/download.jsp?fno=<%= article.getFno() %>"><%= article.getOriName() %></a>&nbsp;<span><%= article.getDownload() %></span>회 다운로드
                    </td>
                </tr>
                <% } %>
                <tr>
            ...
            <section class="commentForm">
                ...
                <form action="#" method="post">
                	...
                	<input type="hidden" name="parent" value="<%= no %>">
 	              	<input type="hidden" name="uid" value="<%= sessUser.getUid() %>"> <!-- 헤더에 세션o 참조 가능 -->
